...
public class PalindromeChecker {
    ...
    public static boolean isPalindromeRecursive(String text, int start,
                                                int end) {
        if (start >= end) {
            return true;
        }
    ...
    public static void main(String[] args) {
        ...
        boolean result2 = isPalindromeRecursive(inputText, 0,
                inputText.length() - 1);
        boolean result3 = isPalindromeUsingCharArray(inputText);
        System.out.println("\nPalindrome Check Results:");
        System.out.println("1. Using Iterative Approach: " + (result1 ?
                "Palindrome" : "Not a Palindrome"));
        System.out.println("2. Using Recursion: " + (result2 ?
                "Palindrome" : "Not a Palindrome"));
        System.out.println("3. Using Character Array: " + (result3 ?
                "Palindrome" : "Not a Palindrome"));
        scanner.close();
    }
}
